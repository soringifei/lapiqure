...
console.log('Using service account for seeding:', serviceAccountPath);
	...
	const products = [
		{
			...
			tierExclusive: 'gold',
			images: [
				'/images/faux_leather_mixed_with_embossed_zebra_leather_jacket1_optimized.jpg',
			],
		},
		{
	...
	const orders = [
		{
			...
			status: 'processing',
			paymentStatus: 'paid',
			items: [{ productId: 'demo_prod_jacket_zebra', quantity: 1, price: 1850 }],
		...
		},
		{
			...
			status: 'confirmed',
			paymentStatus: 'paid',
			items: [{ productId: 'demo_prod_dress_silk', quantity: 1, price: 1450 }],
		...
		},
		{
			...
			status: 'delivered',
			paymentStatus: 'paid',
			items: [{ productId: 'demo_prod_trousers_wool', quantity: 1, price: 850 }],
		...
		},
		{
			...
			items: [{ productId: 'demo_prod_trousers_wool', quantity: 1, price: 780 }],
